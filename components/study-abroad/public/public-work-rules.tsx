...
export function PublicStudyAbroadWorkRules() {
  return (
    <section
    ...
    >
      <div className="bg-white border border-border/60 rounded-lg p-6 md:p-8 shadow-sm dark:border-border/10 dark:bg-card">
        <div className="flex items-center gap-3 mb-6">
          ...
          >
            Quy định làm việc bán thời gian cho du học sinh
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-heading text-[15px] font-bold text-brand-blue dark:text-foreground">
              Quy định về thời gian & độ tuổi
            </h3>
            <p className="font-body text-sm text-muted-foreground leading-relaxed">
              Theo quy định của Bộ Nhân lực Singapore (MOM), học sinh hệ công lập đáp ứng điều kiện có thể đi làm thêm bán thời gian:
            </p>
          ...
          <div className="space-y-4">
            <h3 className="font-heading text-[15px] font-bold text-brand-blue dark:text-foreground">
              Điều kiện cơ sở đào tạo & Thực tập
            </h3>
            <ul className="space-y-3 font-body text-sm text-brand-dark/95 pl-4 list-disc">
              <li>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-md p-4 flex gap-3 items-start mt-8">
          ...
          <p className="font-body text-xs md:text-sm text-amber-900 leading-normal">
            <strong>Cảnh báo quan trọng:</strong> Làm việc bất hợp pháp (không đúng cơ sở đào tạo, quá số giờ quy định hoặc làm việc khi chưa được cho phép) có thể dẫn tới hình phạt thu hồi Student Pass và trục xuất ngay lập tức từ chính quyền Singapore.
          </p>
        </div>
      </div>
    </section>
