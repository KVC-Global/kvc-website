...
import type { PublicStudyServicesContent } from "@/sanity/public-study-page"
import { publicStudyIcons } from "./public-study-icons"

export function PublicStudyAbroadServices({ content }: { content?: PublicStudyServicesContent }) {
