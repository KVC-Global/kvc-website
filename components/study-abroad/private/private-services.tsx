...
import type { PrivateStudyServicesContent } from "@/sanity/private-study-page"
import { privateStudyIcons } from "./private-study-icons"

export function PrivateStudyAbroadServices({ content }: { content?: PrivateStudyServicesContent }) {
