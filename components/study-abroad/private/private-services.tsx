...
import type { PrivateStudyRelatedServicesContent, PrivateStudyRelatedServiceItem } from "@/sanity/private-study-page"
import { privateStudyIcons } from "./private-study-icons"

export function PrivateStudyAbroadServices({ content }: { content?: PrivateStudyRelatedServicesContent }) {
  const locale = useLocale()
  const isEn = locale === "en"
  const prefix = isEn ? "/en" : "/vi"

  const RELATED_SERVICES: PrivateStudyRelatedServiceItem[] = [
    {
