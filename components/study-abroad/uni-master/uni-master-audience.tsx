...
import type { UniMasterAudienceContent } from "@/sanity/uni-master-page"
...
export function UniMasterAudience({
  className,
  content,
}: {
  className?: string
  content?: UniMasterAudienceContent
}) {
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        ...
        >
          {content?.title || "Đối tượng phù hợp chương trình"}
        </h2>
