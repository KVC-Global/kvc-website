...
import type { UniMasterRelatedServicesContent, UniMasterRelatedServiceItem } from "@/sanity/uni-master-page"
import { uniMasterIcons } from "./uni-master-icons"

export function UniMasterServices({ content }: { content?: UniMasterRelatedServicesContent }) {
  const locale = useLocale()
  const isEn = locale === "en"
  const prefix = isEn ? "/en" : "/vi"

  const RELATED_SERVICES: UniMasterRelatedServiceItem[] = [
    {
