...
export function UniMasterIntro() {
  return (
    <section
    ...
    >
      ...
      <div className="relative aspect-16/10 w-full overflow-hidden rounded-lg shadow-lg lg:col-span-5">
        <Image
          ...
          alt="Nhóm sinh viên thảo luận học tập trong khuôn viên trường"
          fill
      ...
      <div className="flex flex-col lg:col-span-7">
        ...
        >
          Giới thiệu lộ trình Đại học & Thạc sĩ Singapore
        </h2>

        <div className="mt-6 font-body text-sm leading-relaxed text-brand-dark/90 sm:text-base">
          <p className="mb-4">
            Với mạng lưới đối tác rộng khắp tại Singapore, KVC Global mang đến cho học viên nhiều lựa chọn về ngành học, lộ trình và chi phí. Mỗi lộ trình Đại học hay Thạc sĩ đều được tư vấn riêng, rõ ràng và cụ thể, dựa trên:
          </p>
          ...
          <p>
            Nhờ mạng lưới liên kết rộng lớn và đa dạng trường, KVC Global có thể linh hoạt đề xuất trường và ngành học phù hợp nhất với từng hồ sơ học viên, thay vì áp dụng một lộ trình cố định dập khuôn cho mọi học viên.
          </p>
        </div>
      </div>
    </section>
