      ...
      <Container>
        ...
        >
          <motion.div
            ...
            className="relative aspect-16/10 w-full overflow-hidden rounded-lg shadow-lg lg:col-span-5"
          >
            <Image
          ...
          >
            ...
            <div className="mt-6 font-body text-sm leading-relaxed text-brand-dark/90 sm:text-base">
              ...
              <ul
                ...
                aria-label="Đặc điểm chương trình"
              >
        ...
        >
          <motion.section
            ...
            className="flex flex-col rounded-lg border border-border bg-white p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] md:p-8 lg:col-span-6"
          >
              ...
              {MAJORS.map((major, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-heading text-[12px] leading-tight font-bold text-brand-blue md:text-[13px]">
                      {major.name}
                    </span>
                  </div>
                )
          ...
          <motion.section
            ...
            className="relative flex flex-col justify-between overflow-hidden rounded-lg border border-border bg-white p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] md:p-8 lg:col-span-6"
          >
            <div className="flex h-full flex-col gap-6 md:flex-row">
              <div className="z-10 flex flex-1 flex-col justify-between gap-6 lg:max-w-[62%]">
                <div>
                  <div className="mb-8 text-center md:text-left">
                    ...
                    <div className="mx-auto mt-2 h-0.5 w-12 rounded-full bg-brand-gold md:mx-0" />
                  </div>
                  ...
                  <ul className="space-y-4" aria-label="Điều kiện tham gia">
                    {REQUIREMENTS.map((req, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        ...
                        <span className="font-body text-[14px] leading-relaxed text-brand-dark/90 md:text-[15px]">
                          {req}
                        </span>
                      </li>
                    ))}
                ...
                <div className="mt-6 flex items-start gap-3 rounded-md border border-[#FFE7C4] bg-[#FFF8EE] p-4">
                  <Lightbulb
                    className="mt-0.5 h-5 w-5 shrink-0 text-brand-gold"
                    strokeWidth={2}
                  />
                  <p className="font-body text-xs leading-normal text-brand-blue/90 md:text-sm">
                    KVC Global sẽ tư vấn chi tiết điều kiện đầu vào phù hợp với
                    từng trường và ngành học học viên quan tâm.
                  </p>
                </div>
              </div>

              <div className="relative flex h-[250px] w-full shrink-0 items-end justify-center overflow-hidden rounded-md md:hidden">
                <Image
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 z-0 hidden overflow-hidden md:block md:w-[38%] lg:w-[35%]">
              <Image
                src="/images/student-portrait.jpg"
                alt="Học viên"
                fill
        ...
        >
          ...
          >
            <div className="relative z-10 flex h-full max-w-[72%] flex-col justify-between sm:max-w-[75%]">
              <div>
                <h2
                  ...
                  className="text-left font-heading text-xl font-bold text-brand-blue sm:text-2xl"
                >
                  Cơ hội sau khi tốt nghiệp
                </h2>
                <div className="mt-2 h-0.5 w-12 rounded-full bg-brand-gold" />
            ...
            <div className="pointer-events-none absolute right-0 bottom-0 z-0 h-[150px] w-[150px] opacity-40 sm:h-[180px] sm:w-[180px] lg:h-[205px] lg:w-[205px]">
              <Image
                ...
                return (
                  ...
                  >
                    <div className="group flex min-h-[160px] w-full flex-1 flex-col items-center justify-center rounded-md border border-border/60 bg-white p-4 text-center transition-all duration-300 hover:bg-brand-light/40 hover:shadow-xs">
                      ...
                      <span className="font-body text-[12px] leading-normal font-bold text-brand-blue md:text-[13px]">
                        {step.text}
                      </span>
                    </div>

                    {!isLast && (
                      <div className="my-2 shrink-0 self-center lg:mx-2 lg:my-0">
                        <svg
                          className="block h-5 w-5 animate-pulse text-muted-foreground/60 lg:hidden"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          strokeWidth="2.5"
        ...
        >
          ...
          >
            <button
              ...
              className="absolute top-1/2 left-0 z-10 hidden h-11 w-11 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-border bg-white text-brand-blue shadow-sm transition-all hover:scale-105 hover:bg-brand-light md:flex"
            >
            ...
            >
              {TESTIMONIALS.map((testi, idx) => (
                <div
                  key={idx}
                  className="relative flex min-h-[220px] w-[90%] shrink-0 snap-start flex-col justify-between overflow-hidden rounded-lg border border-border bg-white p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_8px_30px_-10px_rgba(10,37,64,0.08)] sm:w-[46%] lg:w-[31.5%]"
                >
                  <span
                    aria-hidden="true"
                  ...
                  <div className="relative z-10 flex gap-4">
                    <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-full border border-border/80 bg-brand-light shadow-xs sm:h-16 sm:w-16">
                      <Image
                        src={testi.avatar}
                        alt={testi.name}
                        fill
            ...
            <button
              ...
              className="absolute top-1/2 right-0 z-10 hidden h-11 w-11 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-border bg-white text-brand-blue shadow-sm transition-all hover:scale-105 hover:bg-brand-light md:flex"
            >
        ...
        <motion.section
          ...
          className="mt-20 md:mt-28"
        >
          <motion.div variants={fadeUpVariants} className="mb-8 text-left">
            <h2
              id="faq-heading"
              className="font-heading text-xl font-bold text-brand-blue sm:text-2xl"
            >
            ...
            >
              {FAQS.slice(0, 2).map((faq, index) => {
                ...
                return (
                  <div
                    key={globalIdx}
                    className="overflow-hidden rounded-lg border border-border/60 bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] transition-all duration-300"
                  >
                    <button
                      onClick={() => toggleFaq(globalIdx)}
                      aria-expanded={isOpen}
                      className="flex w-full cursor-pointer items-center justify-between gap-4 p-5 text-left font-heading text-[14px] font-bold text-brand-blue transition-colors duration-200 hover:text-brand-gold md:p-6 md:text-[15px]"
                    >
                      <span>{faq.question}</span>
                      <ChevronDown
                        className={cn(
                          "h-4 w-4 shrink-0 text-brand-blue/60 transition-transform duration-300",
                    ...
                    <div
                      className={cn(
                        "grid font-body text-xs text-brand-dark/85 transition-all duration-300 ease-in-out md:text-sm",
                        isOpen
                    ...
                    >
                      <div className="overflow-hidden">
                        <div className="border-t border-border/20 p-5 pt-0 leading-relaxed md:p-6">
                          {faq.answer}
                        </div>
                      </div>
                    </div>
