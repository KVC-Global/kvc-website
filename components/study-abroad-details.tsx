          ...
          <div className="relative group/nav px-0 md:px-8">
            ...
            >
              {TESTIMONIALS.map((testi, idx) => (
                <div
                  key={idx}
                  className="snap-start shrink-0 w-[90%] sm:w-[46%] lg:w-[31.5%] border border-border bg-white rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_-10px_rgba(10,37,64,0.08)] transition-all duration-300 relative flex flex-col justify-between overflow-hidden min-h-[220px]"
                >
            ...
            <div className="flex flex-col gap-4">
              {FAQS.slice(0, 3).map((faq, index) => {
                ...
                return (
                  <div
                    key={globalIdx}
                    className="bg-white border border-border/60 rounded-2xl overflow-hidden transition-all duration-300 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)]"
                  >
                    <button
